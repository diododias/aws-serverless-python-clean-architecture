...
from process_ride_planning_request.interface_adapters.handler_request import \
    MessageSchema, \
    SnsSchema
from process_ride_planning_request.interface_adapters.handler_response import HandlerResponse


class ProcessRidePlanningRequestHandler:
    _use_case: ProcessRidePlanningRequestUseCaseInterface
    _batch_processor: BatchProcessor
    _logger = Logger(serialize_stacktrace=True)

    def __init__(self,
                 request_ride_planning_use_case: ProcessRidePlanningRequestUseCaseInterface,
