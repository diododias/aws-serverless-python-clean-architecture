...
from src.drivers_adapters.dynamodb_constants import RIDE_PROPERTIES_HASH, PRIMARY_KEY, SORT_KEY
from src.drivers_adapters.ride_planning_dynamodb_mapper import map_ride_planning_to_persistence_schema, \
    map_persistence_schema_to_ride_planning

DynamodbResourceTable = NewType("dynamodb_resource_table", object)
