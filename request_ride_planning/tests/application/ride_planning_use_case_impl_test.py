...
class TestRidePlanningUseCaseImpl:
    ...
    def test_return_ride_planning_id_when_execute_successfull(self):
        # arrange
        notification_gateway_mock = mock.Mock(spec=RidePlanningNotificationGateway)
        notification_gateway_mock.send = mock.Mock()

        persistence_gateway_mock = mock.Mock(spec=RidePlanningPersistenceGateway)
        ...
        use_case = RequestRidePlanningUseCaseImpl(persistence_gateway_mock, notification_gateway_mock)
        ...
        ride_planning_id: RidePlanningId = use_case.execute(
            ...
            departure_datetime=self.mock_event.get("departure_datetime")
        )
